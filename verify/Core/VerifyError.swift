...
extension VerifyError: LocalizedError {
	public var errorDescription: String? {
        ...
        case .missingSessionId:
            return NSLocalizedString("The session id is empty or missing. To initialize the view, specify the session id before displaying the view.", comment: "Session id missing")
		}
	}
}
